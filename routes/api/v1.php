...
Route::prefix('blogs')->group(function () {
    ...
    Route::get('/preview/{slug}', [BlogController::class, 'preview'])->name('v1.blogs.preview');
...
Route::prefix('projects')->group(function () {
    ...
    Route::get('/preview/{slug}', [ProjectController::class, 'preview'])->name('v1.projects.preview');
